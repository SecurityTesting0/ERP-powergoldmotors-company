...
//distributor info
$query1="SELECT * FROM `return_invoices` where id=$rid";	 				
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(190	,4,'RETURN INVOICE',0,1,'C');
...
//distributor info
$query2="SELECT * FROM `return_invoices` where return_invoice_id=$rid";	 				
...
//Table Boday 
$query3="SELECT * FROM `return_invoice_details` where invoice_id=$rid";	 				
...
$totalcal="SELECT * FROM `return_invoices` where return_invoice_id=$rid";	 				
