					...
					<div class="form-group from_border_3">
						<?php
							if (isset($_POST["submit"]) 
								...
								tax,tax_amount,amount_paid, amount_due, notes,created,reciept_cat,saller_id)
								values('$dis_code','$invoice_total','$invoice_subtotal','$tax_percent',
								'$taxAmount','$amount_paid','$amount_due','$note','$date','1','$userid')";
												...
												$options="";
															...
															$id++; 
																...
																if ($resultsstock){
																	...
																	<input type="hidden" name="stock[]" value="<?php echo $stcok['stock_quantity'];?>" />
																	<?php 
