						...
						<?php
							...
							if(isset($_POST["addProdduct"])) {
								...
								if($product_id & $qty==null){
										echo "<script type='text/javascript'>alert('Please Select Product & Quantity')</script>"; 
							
								}else{							
								$total=$qty*$price;
								
								//$invq="INSERT INTO `temp_invoice_details` (`id`, `invoice_id`, `product_id`, `product_name`, `quantity`, `price`,purchase_price) 
								$invq="INSERT INTO `temp_invoice_details` 
								(`disCode`,`product_id`,`invoice_id`, `quantity`, `price`,purchase_price,total) 
								VALUES ('$dis_code','$product_id','$invoice_id','$qty', '$price', 'purchase price', '$total')";
								$db->insert($invq);
								}
							}
						...
						<h4 class="well text-center"><span style="color:#fff; font-weight:bold;">Sales Area</span></h4>
						  <form action="" method ="post" enctype="">
							  ...
							  <div class="col-xs-3 col-md-3 col-sm-3" >
									...
									<div class="form-group">
										<input type="text" class="form-control" name="invoice_no" value="<?php echo $invoice?>" />
									</div>  												
							  </div> 
							 ...
							 <!-- Product area -->  
								 ...
								 <table>
									...
									style="width:300px;" >
									  ...
									  <option value="<?php echo $dis['product_code'];?> " >
									  
									<?php echo $dis['product_code'].'-'.$dis['product_name'];?>
							...
							<br />
							 ...
							 <table class="table table-bordered " id="invoiceTable">
										...
										<tr class="bg-warning">
											...
											<?php 
												...
												if ($delqty==true) {
													...
													if($resqtyd==true){
														echo "<script type='text/javascript'>window.location='sales3.php'; </script>"; 
													}
													
												}
											?>
												<a href="sales3.php?qtydel='<?php echo $temres['id'];?>'" class=" btn-danger btn-sm"> 
								...
								<table>
									...
									<td>											
									<input type="text" name="tax_percent" class="form-control input-sm" placeholder="Ex. 10" />
									</td>
									<td class="text-right">Discount(%)=</td>
									<td>											
									<input type="text" name="discount" class="form-control input-sm" placeholder="Ex. 10" />
									</td>
