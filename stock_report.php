			 ...
			 <div class="container">
				<div class="row">	
					...
					<div class="form-group from_border_3">
						<h4 class="well text-center"> <span style="color:#fff;">Available Stock</span></h4>
							...
							<table id="example" class="table table-striped table-bordered" style="width:95%">
								...
								<tbody>
										<?php
											$query="SELECT * FROM stock_product order by id DESC";
									 ...
									 <tr class="unread">								
										...
										<td><?php echo number_format((float)$rs['price'], 2, '.', ',') ; ?></td>
										<td> 
										<a href="edit_product.php?id='<?php echo $rs['id']; ?>'" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a> 
