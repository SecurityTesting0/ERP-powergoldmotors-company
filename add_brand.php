			 ...
			 <div class="container">
				<div class="row">	
					...
					<div class="form-group from_border">
						...
						<h4 class="well text-center"><span style="color:#fff;">All Brand List</span></h4>
						<div class="wrapper_about text-center">
						<?php 
							if(isset($_POST[submit])){
								$cat_name=$_POST['cat_name'];
								
								$query="INSERT INTO brand_name(name) values ('$cat_name')";
						...
						?>
						 <form action="" method="post">
						  <div class="form-row">
							...
							<?php
								$query="SELECT * From brand_name where id=$rid";
						...
						<table id="example" class="table table-striped table-bordered" style="width:95%">
							...
							?> 
								 <tr class="unread">
                                  ...
                                  <td ><a href="add_brand.php?id='<?php echo $rs['id']; ?>'" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a> <a href="" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a></td> 
                              </tr> 
							  <?php } }?>
							</tbody>
							<tfoot>
